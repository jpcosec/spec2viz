---
# checklist-xxx
id: checklist-task-sync-golden-plantuml-files-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-sync-golden-plantuml-files-ready-for-closeout
- condition-task-sync-golden-plantuml-files-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
